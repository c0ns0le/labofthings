...
namespace HomeOS.Hub.Apps.CameraImager
{
    ...
    [ServiceKnownType(typeof(CameraImager.CameraControl))]
    [AddIn("HomeOS.Hub.Apps.CameraImager")]
    public class CameraImager : ModuleBase
    {
        ...
        public bool wantImage = false;

        public override void Start()
        {
            logger.Log("Started: {0}", ToString());

            CameraImagerSvc service = new CameraImagerSvc(logger, this);
