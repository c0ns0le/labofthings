...
namespace HomeOS.Hub.Apps.Dummy2
{
    ...
    [System.AddIn.AddIn("HomeOS.Hub.Apps.Dummy2")]
    public class Dummy2 :  ModuleBase
    {
        ...
        public override void Start()
        {
            ...
            {
                Work();
            }, "AppDummy2-worker", logger);
            worker.Start();
        }

        public override void Stop()
        {
            logger.Log("AppDummy2 clean up");
            if (worker != null)
                worker.Abort();
            if (datastream != null)
                datastream.Close();
