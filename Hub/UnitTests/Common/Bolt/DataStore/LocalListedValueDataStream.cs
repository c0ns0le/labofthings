...
{
    [TestClass]
    public class LocalListedValueDataStream
    {
        IStream vds;
        StrKey k1;
        StrKey k2;
        ...
        [TestMethod]
        public void LocalListedValueDataStreamTest_TestGetByteValue()
        {
        ...
        [TestMethod]
        public void LocalListedValueDataStreamTest_TestGetAllStrValue()
        {
