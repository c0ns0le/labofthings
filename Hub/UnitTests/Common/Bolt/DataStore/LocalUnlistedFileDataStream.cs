...
{
    [TestClass]
    public class LocalUnlistedFileDataStream
    {
        IStream vds;
        StrKey k1;
        StrKey k2;
        ...
        public void Setup()
        {
            ...
            vds = sf.openDirStream<StrKey>(fqstreamid, ci,
                                           null,
        ...
        [TestMethod]
        public void LocalUnlistedFileDataStreamTest_TestUpdateByteValue()
        {
        ...
        [TestMethod]
        public void LocalUnlistedFileDataStreamTest_TestGetByteValue()
        {
        ...
        [TestMethod]
        public void LocalUnlistedFileDataStreamTest_TestGetAllStrValue()
        {
