...
{
    [TestClass]
    public class LocalListedFileDataStream
    {
        IStream vds;
        StrKey k1;
        StrKey k2;
        ...
        [TestMethod]
        public void LocalListedFileDataStreamTest_TestUpdateByteValue()
        {
        ...
        [TestMethod]
        public void LocalListedFileDataStreamTest_TestGetByteValue()
        {
        ...
        [TestMethod]
        public void LocalListedFileDataStreamTest_TestGetAllStrValue()
        {
